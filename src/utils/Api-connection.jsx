...
export const createProduct = async (data, successCallback, errorCallback) => {
  const options = {
    method: 'POST',
    url: 'https://enigmatic-shore-85040.herokuapp.com/products/',
    headers: {
...
export const obtainProductById = async (id, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/products/${id}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainProductByDescrip = async (descrip, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/products/d/${descrip}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainProductByState = async (state, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/products/s/${state}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const updateProductInfo = async (id, dataToUpdate, successCallback, errorCallback) => {
  var options = {
    method: 'PATCH',
    url: `https://enigmatic-shore-85040.herokuapp.com/products/upd/${id}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    },
...
export const createUser = async (data, successCallback, errorCallback) => {
  var options = {
    method: 'POST',
    url: 'https://enigmatic-shore-85040.herokuapp.com/users/',
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    },
...
export const updateUser = async (id, dataToUpdate, successCallback, errorCallback) => {
  var options = {
    method: 'PATCH',
    url: `https://enigmatic-shore-85040.herokuapp.com/users/upd/${id}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    },
...
export const obtainUserById = async (id, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/users/${id}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainUserByRole = async (role, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/users/r/${role}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainUserByEmail = async (email, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/users/e/${email}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainOrders = async (successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: 'https://enigmatic-shore-85040.herokuapp.com/orders/',
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainOrderById = async (id, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/orders/${id}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainOrderByClientId = async (idclient, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/orders/idclient/${idclient}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainOrderByClientName = async (clientname, successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: `https://enigmatic-shore-85040.herokuapp.com/orders/clientname/${clientname}/`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const obtainClients = async (successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: 'https://enigmatic-shore-85040.herokuapp.com/clients/',
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    }
...
export const updateOrder = async (idOrder, dataToUpdate, successCallback, errorCallback) => {
  var options = {
    method: 'PUT',
    url: `https://enigmatic-shore-85040.herokuapp.com/orders/upd/${idOrder}/`,
    headers: {
       'Content-Type': 'application/json',
      Authorization: getToken(),
      },
...
export const obtainUserData = async (successCallback, errorCallback) => {
  var options = {
    method: 'GET',
    url: 'https://enigmatic-shore-85040.herokuapp.com/users/auth/self/',
    headers: {
      'Content-Type': 'application/json',
      Authorization: getToken(),
    },
